...
TRACE_START = "\x00__TRACES__BEGIN__"
TRACE_END = "\x00__TRACES__END__"
...
async def chat(request: ChatRequest):
    ...
    messages, traces = await run_agent(messages)
    ...
    async def generate():
        ...
        if traces:
            ...
            yield TRACE_START + json.dumps(traces) + TRACE_END
